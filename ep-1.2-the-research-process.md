...
![You belong in The Carpentries!](../../assets/images/research-process.png){alt='Blue Carpentries hex person logo with no text.'}

![You belong in The Carpentries!](../assets/images/research-process.png){alt='Blue Carpentries hex person logo with no text.'}

![You belong in The Carpentries!]({{ site.baseurl }}/assets/images/research-process.png){alt='Blue Carpentries hex person logo with no text.'}

![You belong in The Carpentries!](pre-seeds-research-101/assets/images/research-process.png){alt='Blue Carpentries hex person logo with no text.'}
